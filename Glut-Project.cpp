...
//******************* NAFIUR RASHID CHOWDHURY (19-41066-2) *****************
//footpath
void footpath()//FUNC24
{
    //footpath_down
    //glColor3ub(131,131,131);
    //drawQuad(-100,-98,100,-98,100,-92,-100,-92);

    //gray_shade_down
    //glColor3ub(131,129,129);
    //drawQuad(-100,-100,100,-100,100,-98,-100,-98);

    //dark_line
    //glLineWidth(2);
    //glColor3ub(0,0,0);
    //drawLine(-100,-98,100,-98);
...
void buildingWindows(int r, int g,  int b)//FUNC30
{
    ...
    drawBuildingWindows(-92,5,90,10);
           ...
           //drawBuildingWindows(-89,5,70,6);
     //drawBuildingWindows(-87,5,70,6);
    ...
    //drawBuildingWindows(-18.5,5,70,8);
    //drawBuildingWindows(-16.5,5,70,8);


     drawBuildingWindows(1,5,80,15);
     drawBuildingWindows(9,5,80,15);

     //drawBuildingWindows(51,5,70,12);
...
void buildings(GLfloat r,GLfloat g,GLfloat b)//FUNC31
{
    ...
    glColor3ub(r,g,b);
     ...
     //drawBuilding(75,80,90);
    // drawBuilding(85,90,105);
     //drawBuilding(91,96,100);
